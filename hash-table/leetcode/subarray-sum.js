...
//   const numSums = new Map();

//   for (let i = 0; i < nums.length; i++) {
//     let canonical = String(i);
//     let sum = nums[i];

//     numSums.set(canonical, sum);

//     for (let j = i + 1; j < nums.length; j++) {
//       canonical = String(canonical + j);

//       numSums.set(canonical, sum + nums[j]);
//     }
//   }

//   const targetArr = Array.from(numSums.entries()).find(
//     (subArr) => subArr[1] === target,
//   );

//   let result = [];

//   if (targetArr) {
//     const splittedCanonical = targetArr[0].split("");
//     result = [
//       Number(splittedCanonical[0]),
//       Number(splittedCanonical[splittedCanonical.length - 1]),
//     ];
//   }
